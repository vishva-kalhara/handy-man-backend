...
import io.github.vishvakalhara.handymanbackend.domains.dtos.reviews.GetOneReviewResponse;
...
public class ReviewController {
    ...
    public ResponseEntity<GetOneReviewResponse> updateReview(
            @PathVariable UUID reviewId, @RequestBody UpdateReviewRequest requestBody){

        return ResponseEntity.ok(new GetOneReviewResponse());
    }

    @GetMapping("/me")
    public ResponseEntity<List<GetOneReviewResponse>> getMyReviews(){
